...
app.get('/api/servidores', (req, res) => {
    var q = `select s.id_servidor, s.siape, s.id_pessoa, s.matricula_interna, s.nome_identificacao,
...
app.post('/api/servidor/', (req, res) => {
    ...
    var bid = parseInt(md5(req.body.nome_identificacao+new Date().toString()), 16) % 999999;
    var q= util.format(`INSERT INTO rh.servidor_tmp(
